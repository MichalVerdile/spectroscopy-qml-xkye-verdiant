...
class PathConfig:
    ...
    # Output paths
    model_dir: str = "src/spectroscopy_qml/cnmr/mps_classifier_cnmr/models1"
    results_dir: str = "src/spectroscopy_qml/cnmr/mps_classifier_cnmr/results1"

    # Model checkpoint
    best_model_path: str = "src/spectroscopy_qml/cnmr/mps_classifier_cnmr/models1/mps_model_best.pt"

    # Results
    summary_path: str = "src/spectroscopy_qml/cnmr/mps_classifier_cnmr/results1/summary.txt"
    training_log_path: str = "src/spectroscopy_qml/cnmr/mps_classifier_cnmr/results1/training_log.csv"
...
class GridSearchConfig:
    ...
    grid_search_results_csv: str = (
        "src/spectroscopy_qml/cnmr/mps_classifier_cnmr/results/grid_search/grid_search_results.csv"
    )
    grid_search_summary_path: str = (
        "src/spectroscopy_qml/cnmr/mps_classifier_cnmr/results/grid_search/grid_search_summary.txt"
    )
