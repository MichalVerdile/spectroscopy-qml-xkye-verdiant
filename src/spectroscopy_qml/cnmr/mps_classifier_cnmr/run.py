...
Examples:
  ...
  python run.py --train --evaluate
    ...
    if args.check:
        ...
        # Check model
        try:
            from spectroscopy_qml.cnmr.mps_classifier_cnmr import MPSFunctionalGroupClassifier
    ...
    if args.grid_search:
        ...
        try:
            from spectroscopy_qml.cnmr.mps_classifier_cnmr.grid_search import run_grid_search
    ...
    if args.evaluate:
        ...
        try:
            ...
            from spectroscopy_qml.cnmr.mps_classifier_cnmr.evaluate import main as evaluate_main
