...
from src.spectroscopy_qml.cnmr.boosted_tree_tensor_network.helpers.losses import build_loss  # noqa: E402
...
from src.spectroscopy_qml.cnmr.boosted_tree_tensor_network.helpers.evaluation_helpers import (  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("cnmr/boosted_tree_tensor_network/results"),
    )
