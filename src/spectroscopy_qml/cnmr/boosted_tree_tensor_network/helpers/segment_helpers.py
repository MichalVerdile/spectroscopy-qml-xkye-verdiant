...
from src.spectroscopy_qml.cnmr.boosted_tree_tensor_network.helpers.isometric_helpers import (
    RelaxedIsometricMerge,
    SegmentLeafEncoder,
)

DEFAULT_SEGMENT_WINDOW_SIZE = 48
TARGET_SEGMENT_OVERLAP_RATIO = 0.1
...
def validate_target_segment_overlap(
    ...
    if abs(mean_overlap_ratio - target_overlap_ratio) > tolerance_ratio + 0.5:
        raise ValueError(
