"""Experiment 10.2 TTN classifier with analytical Lorentzian derivative feature map for C-NMR.

Adapted from IR experiment 10.2 with input dimension of 10000 for C-NMR spectra (instead of 1800 for IR).
...
class TTNCNMRClassifier10_2(nn.Module):
    """Experiment 10.2 TTN classifier for C-NMR with Lorentzian-smoothed feature channels.

    Architecture is identical to IR experiment 10.2 except:
    - Input dimension: 10000 (C-NMR) instead of 1800 (IR)
    - Otherwise identical architecture with direct segment states and linear readout
    """
    ...
    def __init__(
        ...
        # For C-NMR, use more lenient overlap validation
