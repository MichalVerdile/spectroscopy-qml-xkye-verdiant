...
from spectroscopy_qml.msms_neg.tree_tensor_network.experiment.experiment6.model import (
...
class TTNIRClassifier10(nn.Module):
    """Experiment 10 TTN classifier with direct segment states."""
    ...
    def __init__(
        ...
        self.output_head = nn.Sequential(
            nn.Linear(readout_dim, self.readout_hidden_dim),
            nn.GELU(),
