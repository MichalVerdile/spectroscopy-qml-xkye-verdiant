...
from spectroscopy_qml.msms_neg.tree_tensor_network.experiment.experiment10_2.model import (  # noqa: E402
    DEFAULT_SEGMENT_STRIDE,
    DEFAULT_SEGMENT_WINDOW_SIZE,
    TTNIRClassifier10_2,
)
from spectroscopy_qml.msms_neg.tree_tensor_network.experiment.experiment10.train import (  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("src/spectroscopy_qml/msms_neg/tree_tensor_network/experiment/experiment10_2/results_test"),
    )
    ...
    parser.add_argument("--gpu-id", type=int, default=3, help="GPU ID to use (0-3 for your 4 GPUs). Only used when --device is 'cuda'.")
...
def main() -> None:
    ...
    split_path = args.split_path or (args.output_dir / f"data_split_seed_msms_neg{args.seed}_{split_suffix}.npz")
