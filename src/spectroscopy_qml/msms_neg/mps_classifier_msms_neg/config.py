...
class PathConfig:
    ...
    # Output paths
    model_dir: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/models_test"
    results_dir: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/results_test"

    # Model checkpoint
    best_model_path: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/models_test/mps_model_best.pt"

    # Results
    summary_path: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/results_test/summary.txt"
    training_log_path: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/results_test/training_log.csv"
...
class GridSearchConfig:
    ...
    grid_search_results_csv: str = (
        "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/results/grid_search/grid_search_results.csv"
    )
    grid_search_summary_path: str = (
        "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/results/grid_search/grid_search_summary.txt"
    )
