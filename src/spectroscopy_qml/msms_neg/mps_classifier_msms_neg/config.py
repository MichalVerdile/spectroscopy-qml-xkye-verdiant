...
class PathConfig:
    ...
    # Output paths
    model_dir: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/models_600"
    results_dir: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/results_600"

    # Model checkpoint
    best_model_path: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/models_600/mps_model_best.pt"

    # Results
    summary_path: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/results_600/summary.txt"
    training_log_path: str = "src/spectroscopy_qml/msms_neg/mps_classifier_msms_neg/results_600/training_log.csv"
