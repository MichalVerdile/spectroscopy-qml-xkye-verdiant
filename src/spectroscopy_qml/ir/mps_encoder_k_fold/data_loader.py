...
def create_dataloader(
    ...
    dataset = IRSpectraDataset(spectra, labels)
    return DataLoader(
        dataset,
...
def split_train_test(
    ...
    """Split the dataset into train and held-out test partitions."""
...
def prepare_dataloaders(
    ...
    This helper is retained for compatibility with train/val/test workflows.
    The main MPS training path now uses a held-out test split plus k-fold
