"""Restored TTN model matching the earlier 0.65-F1 training setup."""
...
class Baseline65TTNIRClassifier(nn.Module):
    """Restored TTN classifier used by the earlier 0.65-F1 experiment."""
