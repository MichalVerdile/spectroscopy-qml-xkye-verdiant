"""Training entry point for experiment 10.1."""
...
from spectroscopy_qml.ir.tree_tensor_network.experiment.experiment10_1.model import (  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Train experiment10.1: TTN IR classifier with direct segmented states, "
            "no leaf encoder, and linear readout (no MLP feature extension)."
        )
    )
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("src/spectroscopy_qml/ir/tree_tensor_network/experiment/experiment10_1/results"),
    )
...
def build_model(args: argparse.Namespace) -> TTNIRClassifier10_1:
    return TTNIRClassifier10_1(
...
def describe_args(args: argparse.Namespace, split_path: Path) -> None:
    print("=" * 80)
    print("TTN IR Experiment10.1 Training")
    print("=" * 80)
