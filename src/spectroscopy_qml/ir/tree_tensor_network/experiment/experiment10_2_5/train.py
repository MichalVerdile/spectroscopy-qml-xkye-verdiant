"""Experiment 10.2.5: Train Quanvolutional specialist heads on diagnostic spectral windows."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Train Quanvolutional specialist heads (Exp 10.2.5)."
    )
    ...
    parser.add_argument("--output-dir", type=Path,
                        default=Path("src/spectroscopy_qml/ir/tree_tensor_network"
                                     "/experiment/experiment10_2_5/results"))
    ...
    parser.add_argument("--patch-size", type=int, default=4,
                        help="Quanvolution patch size / number of qubits.")
    parser.add_argument("--stride", type=int, default=2,
                        help="Stride between quanvolution patches.")
    parser.add_argument("--n-filters", type=int, default=8,
                        help="Number of fixed quanvolution filters per head.")
    parser.add_argument("--quanv-seed", type=int, default=42,
...
def write_summary(path, *, specialist_names, best_epoch, best_score,
    ...
    lines = [
        "Experiment 10.2.5 — TTN 10.2 + Quanvolutional Specialist Head Summary",
        "=" * 80,
        f"Specialist classes:    {', '.join(specialist_names)}",
        f"Quanv patch size:      {args.patch_size}",
