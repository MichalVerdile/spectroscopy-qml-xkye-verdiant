...
Examples:
  ...
  python run.py --train --evaluate
    ...
    if args.check:
        ...
        # Check model
        try:
            from spectroscopy_qml.ir.mps_classifier import MPSFunctionalGroupClassifier
    ...
    if args.grid_search:
        ...
        try:
            from spectroscopy_qml.ir.mps_classifier.grid_search import run_grid_search
    ...
    if args.evaluate:
        ...
        try:
            ...
            from spectroscopy_qml.ir.mps_classifier.evaluate import main as evaluate_main
