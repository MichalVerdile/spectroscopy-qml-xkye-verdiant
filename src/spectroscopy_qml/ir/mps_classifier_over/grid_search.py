...
from spectroscopy_qml.ir.mps_classifier_over.config import (
    DATA_CONFIG,
    GRID_SEARCH_CONFIG,
    MODEL_CONFIG,
    PATH_CONFIG,
...
from spectroscopy_qml.ir.mps_classifier_over.data_loader import load_ir_data
from spectroscopy_qml.ir.mps_classifier_over.train import train_model
