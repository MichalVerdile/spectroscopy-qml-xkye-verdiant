...
from spectroscopy_qml.ir.mps_encoder_strides.data_loader import load_ir_data, prepare_dataloaders
from spectroscopy_qml.ir.mps_encoder_strides.model import MPSFunctionalGroupClassifier
...
def train_model(X: np.ndarray | None = None, y: np.ndarray | None = None):
    ...
    print(f"  Segment size: {MODEL_CONFIG.segment_size}")
    ...
    with open(summary_path, "w") as f:
        ...
        f.write(f"  Segment size: {MODEL_CONFIG.segment_size}\n")
        f.write(f"  Stride: {MODEL_CONFIG.stride}\n")
