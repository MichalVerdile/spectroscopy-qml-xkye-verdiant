...
Examples:
  ...
  python run.py --train --evaluate
    ...
    if args.check:
        ...
        # Check model
        try:
            from spectroscopy_qml.ir.mps_encoder_strides import MPSFunctionalGroupClassifier
    ...
    if args.grid_search:
        ...
        try:
            from spectroscopy_qml.ir.mps_encoder_strides.grid_search import run_grid_search
    ...
    if args.evaluate:
        ...
        try:
            ...
            from spectroscopy_qml.ir.mps_encoder_strides.evaluate import main as evaluate_main
