...
from spectroscopy_qml.ir.quantum_mps_classifier.data_loader import (
    FUNCTIONAL_GROUPS,
    IRSpectraDataset,
    load_ir_data,
)
from spectroscopy_qml.ir.quantum_mps_classifier.model import MPSFunctionalGroupClassifier
