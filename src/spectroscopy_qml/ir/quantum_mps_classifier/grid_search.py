...
from spectroscopy_qml.ir.quantum_mps_classifier.config import (
    DATA_CONFIG,
    GRID_SEARCH_CONFIG,
    MODEL_CONFIG,
    PATH_CONFIG,
...
from spectroscopy_qml.ir.quantum_mps_classifier.data_loader import load_ir_data
from spectroscopy_qml.ir.quantum_mps_classifier.train import train_model
