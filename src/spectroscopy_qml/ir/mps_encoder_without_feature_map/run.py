...
Examples:
  ...
  python run.py --train --evaluate
    ...
    if args.check:
        ...
        # Check model
        try:
            from spectroscopy_qml.ir.mps_encoder_without_feature_map import MPSFunctionalGroupClassifier
    ...
    if args.train:
        ...
        try:
            from spectroscopy_qml.ir.mps_encoder_without_feature_map.train import train_model
    ...
    if args.grid_search:
        ...
        try:
            from spectroscopy_qml.ir.mps_encoder_without_feature_map.grid_search import run_grid_search
    ...
    if args.evaluate:
        ...
        try:
            ...
            from spectroscopy_qml.ir.mps_encoder_without_feature_map.evaluate import main as evaluate_main
