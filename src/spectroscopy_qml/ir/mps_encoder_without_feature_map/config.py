...
class PathConfig:
    ...
    # Output paths
    model_dir: str = "src/spectroscopy_qml/ir/mps_encoder_without_feature_map/models"
    results_dir: str = "src/spectroscopy_qml/ir/mps_encoder_without_feature_map/results"

    # Model checkpoint
    best_model_path: str = "src/spectroscopy_qml/ir/mps_encoder_without_feature_map/models/mps_model_best.pt"

    # Results
    summary_path: str = "src/spectroscopy_qml/ir/mps_encoder_without_feature_map/results/summary.txt"
    training_log_path: str = "src/spectroscopy_qml/ir/mps_encoder_without_feature_map/results/training_log.csv"
...
class GridSearchConfig:
    ...
    grid_search_results_csv: str = (
        "src/spectroscopy_qml/ir/mps_encoder_without_feature_map/results/grid_search/grid_search_results.csv"
    )
    grid_search_summary_path: str = (
        "src/spectroscopy_qml/ir/mps_encoder_without_feature_map/results/grid_search/grid_search_summary.txt"
    )
