...
class PathConfig:
    ...
    # Output paths
    model_dir: str = "src/spectroscopy_qml/ir/mps_classifier/models_test"
    results_dir: str = "src/spectroscopy_qml/ir/mps_classifier/results_test"

    # Model checkpoint
    best_model_path: str = "src/spectroscopy_qml/ir/mps_classifier/models_test/mps_model_best.pt"

    # Results
    summary_path: str = "src/spectroscopy_qml/ir/mps_classifier/results_test/summary.txt"
    training_log_path: str = "src/spectroscopy_qml/ir/mps_classifier/results_test/training_log.csv"
