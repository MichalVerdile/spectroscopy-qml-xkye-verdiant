...
class ModelConfig:
    ...
    # TTN configuration
    use_ttn: bool = False
    ttn_internal_dim: int = 512
    freeze_encoder: bool = False
    pretrained_encoder_path: str | None = None

    # TTN Hybrid configuration (per-site + cross-site trees)
    use_ttn_hybrid: bool = True
    per_site_internal_dim: int = 512
    share_site_trees: bool = False
...
class PathConfig:
    ...
    # Output paths
    model_dir: str = "src/spectroscopy_qml/ir/mps_encoder_ttn/models"
    results_dir: str = "src/spectroscopy_qml/ir/mps_encoder_ttn/results"

    # Model checkpoint
    best_model_path: str = "src/spectroscopy_qml/ir/mps_encoder_ttn/models/mps_model_best.pt"

    # Results
    summary_path: str = "src/spectroscopy_qml/ir/mps_encoder_ttn/results/summary.txt"
    training_log_path: str = "src/spectroscopy_qml/ir/mps_encoder_ttn/results/training_log.csv"
...
class GridSearchConfig:
    ...
    grid_search_results_csv: str = (
        "src/spectroscopy_qml/ir/mps_encoder_ttn/results/grid_search/grid_search_results.csv"
    )
    grid_search_summary_path: str = (
        "src/spectroscopy_qml/ir/mps_encoder_ttn/results/grid_search/grid_search_summary.txt"
    )
