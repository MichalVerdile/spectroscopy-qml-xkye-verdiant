...
Examples:
  ...
  python run.py --train --evaluate
    ...
    if args.check:
        ...
        # Check model
        try:
            from spectroscopy_qml.ir.mps_encoder_ttn import MPSFunctionalGroupClassifier
    ...
    if args.train:
        ...
        try:
            from spectroscopy_qml.ir.mps_encoder_ttn.train import train_model
    ...
    if args.grid_search:
        ...
        try:
            from spectroscopy_qml.ir.mps_encoder_ttn.grid_search import run_grid_search
    ...
    if args.evaluate:
        ...
        try:
            ...
            from spectroscopy_qml.ir.mps_encoder_ttn.evaluate import main as evaluate_main
