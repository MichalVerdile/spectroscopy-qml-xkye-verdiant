...
Examples:
  ...
  python run.py --train --evaluate
    ...
    if args.check:
        ...
        # Check model
        try:
            from spectroscopy_qml.ir.mps_encoder_chemical import MPSFunctionalGroupClassifier
    ...
    if args.train:
        ...
        try:
            from spectroscopy_qml.ir.mps_encoder_chemical.train import train_model
    ...
    if args.grid_search:
        ...
        try:
            from spectroscopy_qml.ir.mps_encoder_chemical.grid_search import run_grid_search
    ...
    if args.evaluate:
        ...
        try:
            ...
            from spectroscopy_qml.ir.mps_encoder_chemical.evaluate import main as evaluate_main
