...
from spectroscopy_qml.ir.mps_encoder_derivatives.data_loader import load_ir_data, prepare_dataloaders
from spectroscopy_qml.ir.mps_encoder_derivatives.model import MPSFunctionalGroupClassifier
