...
Examples:
  ...
  python run.py --train --evaluate
    ...
    if args.check:
        ...
        # Check model
        try:
            from spectroscopy_qml.ir.mps_encoder_derivatives import MPSFunctionalGroupClassifier
    ...
    if args.grid_search:
        ...
        try:
            from spectroscopy_qml.ir.mps_encoder_derivatives.grid_search import run_grid_search
    ...
    if args.evaluate:
        ...
        try:
            ...
            from spectroscopy_qml.ir.mps_encoder_derivatives.evaluate import main as evaluate_main
