...
class GridSearchConfig:
    ...
    grid_search_results_csv: str = (
        "src/spectroscopy_qml/msms_pos/mps_classifier_msms_pos/results/grid_search/grid_search_results.csv"
    )
    grid_search_summary_path: str = (
        "src/spectroscopy_qml/msms_pos/mps_classifier_msms_pos/results/grid_search/grid_search_summary.txt"
    )
