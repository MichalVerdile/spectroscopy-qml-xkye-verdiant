...
Examples:
  ...
  python run.py --train --evaluate
    ...
    if args.check:
        ...
        # Check model
        try:
            from spectroscopy_qml.msms_pos.mps_classifier_msms_pos import MPSFunctionalGroupClassifier
    ...
    if args.grid_search:
        ...
        try:
            from spectroscopy_qml.msms_pos.mps_classifier_msms_pos.grid_search import run_grid_search
    ...
    if args.evaluate:
        ...
        try:
            ...
            from spectroscopy_qml.msms_pos.mps_classifier_msms_pos.evaluate import main as evaluate_main
