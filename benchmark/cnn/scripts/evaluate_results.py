...
def calculate_metrics(predictions, targets):
    ...
    metrics['precision'] = precision_score(tgt_classes, pred_classes, average='macro', zero_division=0)
...
def main():
    ...
    parser.add_argument('--models_dir', type=str, default='./benchmark/cnn/models',
                       help='Directory containing model subdirectories')
    parser.add_argument('--output_dir', type=str, default='./benchmark/cnn/results',
